...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if(args.mode=='Source'):
            ...
            t_miou = temp / num
            t_dice = dice_temp / num
            TensorboardWriter.add_scalar('source vali eval miou', t_miou, global_step=epoch)
            TensorboardWriter.add_scalar('source vali eval dice', t_dice, global_step=epoch)
